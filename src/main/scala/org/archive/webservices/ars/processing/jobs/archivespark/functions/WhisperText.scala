...
object WhisperText extends GlobalEnrichFunc[EnrichRoot with LocalFileCache, Json, String] with ArchArchiveSparkFunction[Json] {
  val func: EnrichFunc[EnrichRoot with LocalFileCache, Json, String] = Whisper.map("text") { json =>
