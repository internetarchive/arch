import{_ as e,c as t,b as o,y as s,a}from"./chunk-styles-ad31501a.js";import{t as r}from"./chunk-state-1d3d2492.js";import{A as l,a as c}from"./chunk-arch-alert-ef577355.js";var i;let n=i=class extends o{constructor(){super(...arguments),this.collections=[],this.sourceCollectionIds=new Set}createRenderRoot(){return this}async connectedCallback(){super.connectedCallback(),await this.initCollections(),this.sourceCollectionIds=new Set(new URLSearchParams(window.location.search).getAll(i.urlCollectionsParamName))}get _formData(){const e={},t=Array.from(new FormData(this.form).entries());for(const[o,s]of t){const t=e[o];void 0===t?e[o]=s:Array.isArray(t)?e[o]=t.concat(s):e[o]=[t,s]}return e}render(){const{collections:e,sourceCollectionIds:t}=this,o=e.filter((e=>t.has(e.id)));return s`
      <div class="row">
    ...
    `}async initCollections(){const e=await c.collections.get();this.collections=e.results}setSourceCollectionIdsUrlParam(e){const{urlCollectionsParamName:t}=i,o=new URL(window.location.href);o.searchParams.delete(t),e.forEach((e=>o.searchParams.append(t,e))),history.replaceState(null,"",o.toString())}sourceCollectionsChangeHandler(e){const t=Array.from(e.target.selectedOptions).map((e=>e.value));this.sourceCollectionIds=new Set(t),this.setSourceCollectionIdsUrlParam(t)}async createSubCollection(e){e.preventDefault();const{form:t}=this;if(!t.checkValidity())return void t.reportValidity();const o=e.target;o.disabled=!0;const s=Object.fromEntries(Array.from(Object.entries(this._formData)).filter((([,e])=>""!==e)).map((([e,t])=>[e,"surtPrefixesOR"===e||"statusPrefixesOR"===e||"mimesOR"===e?t.split("|"):t]))),a=s.sources;let r;delete s.sources,Array.isArray(a)?(r="UNION-UDQ",s.input=a):r=a;(await fetch(`/api/runjob/UserDefinedQuery/${r}`,{method:"POST",body:JSON.stringify(s),headers:{"content-type":"application/json"}})).ok?window.location.href="/collections":(window.alert("Could not create Sub-Collection"),o.disabled=!1)}};n.urlCollectionsParamName="cid[]",e([r()],n.prototype,"collections",void 0),e([r()],n.prototype,"sourceCollectionIds",void 0),e([t("form")],n.prototype,"form",void 0),e([t("select#source")],n.prototype,"sourceSelect",void 0),n=i=e([a("arch-sub-collection-builder")],n);export{n as ArchSubCollectionBuilder};
//# sourceMappingURL=arch-sub-collection-builder-46e3dce6.js.map
