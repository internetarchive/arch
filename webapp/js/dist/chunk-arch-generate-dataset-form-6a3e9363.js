import{_ as t,e,a as o,b as a,y as s,i,c as r}from"./chunk-styles-75502ec5.js";import{t as n,A as l,a as c}from"./chunk-arch-alert-a83c3a9d.js";import{e as d}from"./chunk-query-all-273a2103.js";var h,u;!function(t){t.ArsLgaGeneration="ArsLgaGeneration",t.ArsWaneGeneration="ArsWaneGeneration",t.ArsWatGeneration="ArsWatGeneration",t.AudioInformationExtraction="AudioInformationExtraction",t.DomainFrequencyExtraction="DomainFrequencyExtraction",t.DomainGraphExtraction="DomainGraphExtraction",t.ImageGraphExtraction="ImageGraphExtraction",t.ImageInformationExtraction="ImageInformationExtraction",t.PdfInformationExtraction="PdfInformationExtraction",t.PresentationProgramInformationExtraction="PresentationProgramInformationExtraction",t.SpreadsheetInformationExtraction="SpreadsheetInformationExtraction",t.TextFilesInformationExtraction="TextFilesInformationExtraction",t.VideoInformationExtraction="VideoInformationExtraction",t.WebGraphExtraction="WebGraphExtraction",t.WebPagesExtraction="WebPagesExtraction",t.WordProcessorInformationExtraction="WordProcessorInformationExtraction"}(h||(h={})),function(t){t.NotStarted="Not started",t.Queued="Queued",t.Running="Running",t.Finished="Finished",t.Failed="Failed"}(u||(u={}));const p="-SAMPLE";var b;!function(t){t.Generate="generate",t.View="view",t.Status="status"}(b||(b={}));let m=class extends a{createRenderRoot(){return this}jobStateToButtonProps(t){if(!t)return[this.collectionId?"Loading...":"n/a",b.Status,"job-statebutton"];const e=t.sample>0?"Sample ":"";return t.started?t.finished?[`View ${e}Dataset`,b.View,"job-resultsbutton"]:[t.state,b.Status,"job-statebutton"]:[`Generate ${e}Dataset`,b.Generate,"job-runbutton"]}render(){const{collectionId:t,job:e}=this,{id:o}=e,[a,i]=this.jobStates?[this.jobStates[`${o}${p}`],this.jobStates[o]]:[void 0,void 0],[r,n,l]=this.jobStateToButtonProps(a),[c,d,h]=this.jobStateToButtonProps(i),u=t?"":"Select a source collection to enable this button";return s` <div class="card">
      <div class="card-body">
    ...
    `}};t([e({type:Boolean})],y.prototype,"collapsed",void 0),t([e({type:String})],y.prototype,"collectionId",void 0),t([e({type:Object})],y.prototype,"jobsCat",void 0),t([e({type:Object})],y.prototype,"jobStates",void 0),y=t([o("arch-job-category-section")],y);var v,j=i``;let g=v=class extends a{constructor(){super(...arguments),this.collections=null,this.availableJobs=[],this.sourceCollectionId=null,this.jobStates={},this.activePollCollectionId=null,this.anyErrors=!1}async connectedCallback(){await this.initAvailableJobs(),this.initCollections(),super.connectedCallback(),this.addEventListener("click",(t=>{this.clickHandler(t)}))}createRenderRoot(){return this}render(){var t;const e=this.sourceCollectionId&&this.jobStates[this.sourceCollectionId];return s`
      ...
      ${this.availableJobs.map(((t,o)=>s`
        ...
        `))}
    `}setCollectionIdUrlParam(t){const{urlCollectionParamName:e}=v,o=new URL(window.location.href);t?o.searchParams.set(e,t):o.searchParams.delete(e),history.replaceState(null,"",o.toString())}async sourceCollectionChangeHandler(t){const e=t.target.value;this.setCollectionIdUrlParam(e),await this.setSourceCollectionId(e),this.requestUpdate()}updateAnyErrors(){const t=this.sourceCollectionId;if(t)for(const e of Object.values(this.jobStates[t]))if(e.state===u.Failed)return void(this.anyErrors=!0);this.anyErrors=!1}async setSourceCollectionId(t){this.sourceCollectionId=t,t&&(this.jobStates[t]=await this.fetchCollectionJobStates(t)),this.updateAnyErrors()}async initCollections(){const t=await c.collections.get();this.collections=t.results;const e=new URLSearchParams(window.location.search).get(v.urlCollectionParamName);e&&(await this.setSourceCollectionId(e),this.requestUpdate())}async initAvailableJobs(){this.availableJobs=await(await fetch("/api/available-jobs")).json()}async fetchCollectionJobStates(t){const e=await(await fetch(`/api/jobstates/${t}?all=true`)).json();return Object.fromEntries(e.map((t=>[`${t.id}${t.sample>0?p:""}`,t])))}async pollJobStates(){const t=this.sourceCollectionId;if(this.activePollCollectionId===t){this.jobStates[t]=await this.fetchCollectionJobStates(t),this.updateAnyErrors(),this.requestUpdate();for(const e of Object.values(this.jobStates[t]))if(e.state===u.Running)return void setTimeout((()=>{this.pollJobStates()}),2e3);this.activePollCollectionId=null}else this.activePollCollectionId=null}startPolling(){null===this.activePollCollectionId&&(this.activePollCollectionId=this.sourceCollectionId,this.pollJobStates())}expandCategorySection(t){this.categorySections.forEach((e=>{e===t?e.expand():e.collapse()}))}async runJob(t,e){await fetch(`/api/runjob/${t}/${this.sourceCollectionId}${e?"?sample=true":""}`)}async clickHandler(t){const e=t.target,o=e.closest("arch-job-category-section");if(null==o?void 0:o.collapsed)this.expandCategorySection(o);else if("BUTTON"!==e.tagName);else{const{jobId:t,buttonType:o,sample:a}=e.dataset,s=void 0!==a;switch(o){case b.Generate:await this.runJob(t,s),this.emailAlert.show(),this.startPolling();break;case b.View:window.location.href=`/datasets/${this.sourceCollectionId}:${t}${s?"?sample=true":""}`}}}};g.styles=j,g.urlCollectionParamName="cid",t([n()],g.prototype,"collections",void 0),t([n()],g.prototype,"availableJobs",void 0),t([n()],g.prototype,"sourceCollectionId",void 0),t([n()],g.prototype,"jobStates",void 0),t([n()],g.prototype,"activePollCollectionId",void 0),t([n()],g.prototype,"anyErrors",void 0),t([r("select[name=source-collection]")],g.prototype,"collectionSelector",void 0),t([r("arch-alert.error")],g.prototype,"errorAlert",void 0),t([r("arch-alert.email")],g.prototype,"emailAlert",void 0),t([d("arch-job-category-section")],g.prototype,"categorySections",void 0),g=v=t([o("arch-generate-dataset-form")],g);export{g as A,u as P};
//# sourceMappingURL=chunk-arch-generate-dataset-form-6a3e9363.js.map
