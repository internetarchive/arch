...
`,xe=At`
  ...
  .alert-primary {
    color: ${fe};
    background-color: ${At`#cfe2ff`};
    border-color: ${At`#9ec5fe`};
  }
  ...
  .alert-secondary {
    color: ${_e};
    background-color: ${At`#e2e3e5`};
    border-color: ${At`#c4c8cb`};
  }
  ...
  .alert-success {
    color: ${ge};
    background-color: ${At`#d1e7dd`};
    border-color: ${At`#a3cfbb`};
  }
  ...
  .alert-info {
    color: ${me};
    background-color: ${At`#cff4fc`};
    border-color: ${At`#9eeaf9`};
  }
  ...
  .alert-warning {
    color: ${Ae};
    background-color: ${At`#fff3cd`};
    border-color: ${At`#ffe69c`};
  }
  ...
  .alert-light {
    color: ${be};
    background-color: ${At`#fcfcfd`};
    border-color: ${At`#e9ecef`};
  }
  ...
  .alert-dark {
    color: ${Ee};
    background-color: ${At`#ced4da`};
    border-color: ${At`#adb5bd`};
  }

  .alert-dark a {
    color: ${Ee};
  }
`;export{xe as B,$t as G,t as _,e as a,$e as b,r as c,Qt as d,s as e,kt as f,we as g,ft as h,At as i,Ce as j,lt as k,a as l,o,p as r,st as s,Ft as x,Gt as y};
//# sourceMappingURL=chunk-styles-ad31501a.js.map
