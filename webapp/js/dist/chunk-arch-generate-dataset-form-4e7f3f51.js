import{_ as t,e,a as o,s as a,y as s,i,b as r}from"./chunk-styles-4a7b21cd.js";import{t as n,A as l}from"./chunk-arch-alert-3c1ceea9.js";import{e as c}from"./chunk-query-all-2f0be97e.js";var d,h;!function(t){t.ArsLgaGeneration="ArsLgaGeneration",t.ArsWaneGeneration="ArsWaneGeneration",t.ArsWatGeneration="ArsWatGeneration",t.AudioInformationExtraction="AudioInformationExtraction",t.DomainFrequencyExtraction="DomainFrequencyExtraction",t.DomainGraphExtraction="DomainGraphExtraction",t.ImageGraphExtraction="ImageGraphExtraction",t.ImageInformationExtraction="ImageInformationExtraction",t.PdfInformationExtraction="PdfInformationExtraction",t.PresentationProgramInformationExtraction="PresentationProgramInformationExtraction",t.SpreadsheetInformationExtraction="SpreadsheetInformationExtraction",t.TextFilesInformationExtraction="TextFilesInformationExtraction",t.VideoInformationExtraction="VideoInformationExtraction",t.WebGraphExtraction="WebGraphExtraction",t.WebPagesExtraction="WebPagesExtraction",t.WordProcessorInformationExtraction="WordProcessorInformationExtraction"}(d||(d={})),function(t){t.NotStarted="Not started",t.Queued="Queued",t.Running="Running",t.Finished="Finished",t.Failed="Failed"}(h||(h={}));const u="-SAMPLE";var b;!function(t){t.Generate="generate",t.View="view",t.Status="status"}(b||(b={}));let p=class extends a{createRenderRoot(){return this}jobStateToButtonProps(t){if(!t)return[this.collectionId?"Loading...":"n/a",b.Status,"job-statebutton"];const e=t.sample>0?"Sample ":"";return t.started?t.finished?[`View ${e}Dataset`,b.View,"job-resultsbutton"]:[t.state,b.Status,"job-statebutton"]:[`Generate ${e}Dataset`,b.Generate,"job-runbutton"]}render(){const{collectionId:t,job:e}=this,{id:o}=e,[a,i]=this.jobStates?[this.jobStates[`${o}${u}`],this.jobStates[o]]:[void 0,void 0],[r,n,l]=this.jobStateToButtonProps(a),[c,d,h]=this.jobStateToButtonProps(i),p=t?"":"Select a source collection to enable this button";return s` <div class="card">
    ...
    </div>`}};t([e()],p.prototype,"collectionId",void 0),t([e()],p.prototype,"job",void 0),t([e()],p.prototype,"jobStates",void 0),p=t([o("arch-job-card")],p);let m=class extends a{constructor(){super(...arguments),this.collapsed=!1}createRenderRoot(){return this}expand(){this.collapsed=!1}collapse(){this.collapsed=!0}render(){return s`
